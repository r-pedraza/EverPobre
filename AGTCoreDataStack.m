...
//método para buscar cualquier elemento y controlar errores.
//fectch request es aquel objet que utilizabamos para realizar una busqueda.
-(NSArray*)executeSearchWithRequest:(NSFetchRequest*)request errorBlock:(void(^)(NSError *error))errorBlock{
    NSError *err = nil;
